"""Module to check and display the content of the pickled aviation corpus file."""
...
def check_pkl_content():
    """Load and display statistics and details about the pickled aviation corpus."""
    ...
    try:
        ...
        print("Successfully loaded aviation_corpus.pkl")
        ...
        for i, doc in enumerate(corpus[:]):
            ...
            print(
                f"Number Section references: {len(doc.get('section_references', []))}"
            )
